...
const FAQS = () => {
    ...
    <AccordionItem value="item-1">
      <AccordionTrigger>Who is Neuromancer Labs?</AccordionTrigger>
      <AccordionContent>
        Neuromancer Labs is a full fledge marketing agency that specializes in branding, web design, and digital marketing.
      </AccordionContent>
    </AccordionItem>
