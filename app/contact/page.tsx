          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how Neuromancer Labs can help your team work better.
          </div>
            ...
            >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate Bird for my company">
                            Evaluate Neuromancer for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to Neuromancer Labs&apos; sending marketing communications related
                  to bird
                </div>
              </div>
